...
export interface ApiAboutAbout extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'About me profile details';
    displayName: 'About';
    pluralName: 'abouts';
    singularName: 'about';
  };
...
export interface ApiLinkLink extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Desktop shortcut links \u2014 each one opens a website in a browser window';
    displayName: 'Link';
    pluralName: 'links';
    singularName: 'link';
  };
...
export interface ApiTrackTrack extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Music player tracks';
    displayName: 'Track';
    pluralName: 'tracks';
    singularName: 'track';
  };
  ...
  attributes: {
    ...
    audioFile: Schema.Attribute.Media<'files' | 'videos' | 'audios'>;
...
export interface ApiWallpaperWallpaper extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Preset desktop wallpapers';
